...
# (c) D.Mery, 2020
#
from cl_utils import load_data, clf_train_test_ho, PrintConfusion, PlotFeatures, PlotDecisionLines
...
ds,acc,clf  = clf_train_test_ho(clf_name,X,d,Xt,dt,clf_parm)  # training and testing with hold out
