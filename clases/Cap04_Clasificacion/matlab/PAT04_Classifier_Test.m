...
% TRAINING
[X1,d1] = Bds_gaussgen([10 1;5 5],[1 1;1 1],100*ones(2,1));
[X2,d2] = Bds_gaussgen([10 10;10 -4],[1 1;1 1],100*ones(2,1));
[X3,d3] = Bds_gaussgen([1 10 ;5 -1],[1 1;1 1],100*ones(2,1));
[X4,d4] = Bds_gaussgen([5 10 ;5 2.5],[1 1;1 1],100*ones(2,1));
[X5,d5] = Bds_gaussgen([10 5 ;8 -1],[1 1;1 1],100*ones(2,1));
...
k=k+1; b(k).name = 'ann';   b(k).options.hidden = 20;           % 'ANN-20'    
op = b;
